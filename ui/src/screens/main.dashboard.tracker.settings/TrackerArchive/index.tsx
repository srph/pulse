...
class TrackerArchive extends React.Component<ClonedProps, State> {
  ...
  render() {
    return (
      <UiFieldGroup heading="Archive Tracker" tagline="Enter tracker name to archive. You may unarchive this tracker from Home > View Archived Trackers." isDangerous>
